...
static bool getrusageloc(int who, struct rusage *r_usage){
   ...
   // }
    ...
    r_usage->ru_utime.tv_sec = uli.QuadPart / 10000000;
    r_usage->ru_utime.tv_usec = (uli.QuadPart % 10000000) / 10;

    uli.LowPart = kernel_time.dwLowDateTime;
    uli.HighPart = kernel_time.dwHighDateTime;
    r_usage->ru_stime.tv_sec = uli.QuadPart / 10000000;
    r_usage->ru_stime.tv_usec = (uli.QuadPart % 10000000) / 10;
...
static double wall_clock_time_new() {
    FILETIME ft;
    ULARGE_INTEGER uli;
